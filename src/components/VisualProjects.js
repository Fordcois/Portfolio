...
<div className="container">
    ...
    {/* TODO Style Link */}
    <p className='Section-Text'>Here are just a selection of my projects, you can find more projects (as well as those currently in development) on my <a href='https://github.com/Fordcois'>GitHub...</a></p>
